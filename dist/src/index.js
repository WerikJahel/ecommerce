...
const client_1 = require("@main/infra/database/orm/prisma/client");
const database_1 = require("@modules/catalogo/infra/database");
async function main() {
    client_1.prisma.$connect().then(async () => {
    ...
    */
    ...
    /////////////////////////////////////////////////
    const todosProdutos = await database_1.produtoRepositorio.recuperarTodos();
